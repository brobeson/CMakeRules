...
function(all_targets)
  message(CHECK_START "Applying target name rules")
  cmake_parse_arguments(
    arg
    "MUST"
    ""
  ...
  foreach(_TARGET IN LISTS _ALL_TARGETS)
    ...
    if(NOT _TARGET_MATCHES)
      ...
      message(WARNING "Target '${_TARGET}' does not meet name requirement '${arg_MATCH}'. The target is defined in ${_SOURCE_DIR}")
    endif()
  endforeach()
  message(CHECK_PASS "all targets pass")
endfunction()
